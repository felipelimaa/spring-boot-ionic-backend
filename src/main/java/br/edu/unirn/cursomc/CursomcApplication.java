...
public class CursomcApplication implements CommandLineRunner {
	...
	public void run(String... arg0) throws Exception {
		...
		Categoria cat3 = new Categoria(null, "Matmed");
		Categoria cat4 = new Categoria(null, "OPME");
		Categoria cat5 = new Categoria(null, "Material de uso no paciente");
		Categoria cat6 = new Categoria(null, "Material de expediente");
		Categoria cat7 = new Categoria(null, "Consignados");
		Categoria cat8 = new Categoria(null, "Antibióticos");
